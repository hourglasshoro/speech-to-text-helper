...
var rootCmd = &cobra.Command{
	...
	Short: "Speech-to-text-helper is a tool for requesting audio files in bulk to the IBM Watson™ Speech to Text service",
	Long: `
Speech-to-text-helper is a tool for requesting audio files in bulk to the IBM Watson™ Speech to Text service.
Take the directory containing the wav file as input. Execute by specifying the input and output destinations.
`,
